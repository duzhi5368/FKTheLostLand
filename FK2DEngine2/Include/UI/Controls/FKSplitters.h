/**
*	created:		2013-4-12   21:46
*	filename: 		FKSplitters
*	author:			FreeKnight
*	Copyright (C): 	
*	purpose:		
*/
...
namespace FK2DEngine2
{
	namespace Controls
	{
		class FK_EXPORT SplitterVertical : public Controls::Base
		{
				FK_CONTROL_INLINE( SplitterVertical, Controls::Base )
				{
					...
					m_pSplitter->SetCursor( FK2DEngine2::CursorType::SizeNS );
			...
			protected:
				...
				{
					const FK2DEngine2::Rect & inner = GetInnerBounds();
					int iOffset = m_Size;
		...
		class FK_EXPORT SplitterHorizontal : public SplitterVertical
		{
				FK_CONTROL_INLINE( SplitterHorizontal, SplitterVertical )
				{
					m_pSplitter->SetCursor( FK2DEngine2::CursorType::SizeWE );
