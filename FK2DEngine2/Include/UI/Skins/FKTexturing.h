/**
*	created:		2013-4-11   22:55
*	filename: 		FKTexturing
*	author:			FreeKnight
*	Copyright (C): 	
*	purpose:		
*/
	...
	namespace Skin
	{
		namespace Texturing
		{
			struct Single
			{
				...
				void Init( STextureInfo* pTexture, float x, float y, float w, float h )
				{
					texture = pTexture;
				...
				void Draw( FK2DEngine2::video::Base* render, FK2DEngine2::Rect r, const FK2DEngine2::Color & col = FK2DEngine2::Colors::White )
				{
					if ( !texture ) { return; }
				...
				void DrawCenter( FK2DEngine2::video::Base* render, FK2DEngine2::Rect r, const FK2DEngine2::Color & col = FK2DEngine2::Colors::White )
				{
					if ( !texture ) { return; }
			...
			struct Bordered
			{
				...
				void Init( STextureInfo* pTexture, float x, float y, float w, float h, Margin in_margin, float DrawMarginScale = 1.0f )
				{
					texture = pTexture;
					margin = in_margin;
				...
				void Draw( FK2DEngine2::video::Base* render, FK2DEngine2::Rect r, const FK2DEngine2::Color & col = FK2DEngine2::Colors::White, bool b1 = true, bool b2 = true, bool b3 = true, bool b4 = true, bool b5 = true, bool b6 = true, bool b7 = true, bool b8 = true, bool b9 = true )
				{
					if ( !texture ) { return; }
				...
				void DrawRect( FK2DEngine2::video::Base* render, int i, int x, int y, int w, int h )
				{
					render->DrawTexturedRect( texture,
						FK2DEngine2::Rect( x, y, w, h ),
