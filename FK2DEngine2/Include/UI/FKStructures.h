/**
*	created:		2013-4-11   16:55
*	filename: 		FKStructures
*	author:			FreeKnight
*	Copyright (C): 	
*	purpose:		
*/
	...
	namespace DragAndDrop
	{
		struct FK_EXPORT Package
		{
			Package()
			{
				...
				draggable = false;
				drawcontrol = NULL;
				holdoffset = FK2DEngine2::Point( 0, 0 );
			}
			...
			FK2DEngine2::Controls::Base*	drawcontrol;
			FK2DEngine2::Point				holdoffset;
		};
	}
