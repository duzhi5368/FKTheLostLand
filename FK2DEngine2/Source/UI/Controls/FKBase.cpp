...
void Base::DoCacheRender( FK2DEngine2::Skin::Base* skin, FK2DEngine2::Controls::Base* pMaster )
{
	...
	FK2DEngine2::video::ICacheToTexture* cache = render->GetCTT();
...
void Base::SetToolTip( const UITexObjSimpleInfo & strText )
{
...
UITexObjSimpleInfo Base::GetChildValue( const FK2DEngine2::String & strName )
{
...
UITexObjSimpleInfo Base::GetValue()
{
	return "";
}

void Base::SetValue( const UITexObjSimpleInfo & strValue )
{
}
