...
{
		FK_CONTROL_INLINE( CategoryButton, Button )
		{
...
{
		FK_CONTROL_INLINE( CategoryHeaderButton, Button )
		{
...
FK_CONTROL_CONSTRUCTOR( CollapsibleCategory )
{
	m_pList = NULL;
...
Button* CollapsibleCategory::Add( const UITexObjSimpleInfo & name )
{
...
{
	CategoryButton* pChild = fk_cast<CategoryButton> ( control );
...
void CollapsibleCategory::SetText( const UITexObjSimpleInfo & text )
{
...
void CollapsibleCategory::UnselectAll()
{
	...
	{
		CategoryButton* pChild = fk_cast<CategoryButton> ( *iter );
