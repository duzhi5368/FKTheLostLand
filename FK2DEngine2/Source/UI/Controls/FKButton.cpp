...
void Button::SetImage( const UITexObjSimpleInfo & strName, bool bCenter )
{
...
void Button::SetImageAlpha( float f )
{
	...
	m_Image->SetDrawColor( FK2DEngine2::Color( 255, 255, 255, 255.0f * f ) );
}

void Button::SetAction( Event::Handler* pObject, Handler::FunctionWithInformation pFunction, const FK2DEngine2::Event::Packet & packet )
{
