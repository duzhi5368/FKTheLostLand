...
//------------------------------------------------------------------------
class FK_EXPORT RightArrow : public Controls::Base
{
public:

	FK_CONTROL_INLINE( RightArrow, Controls::Base )
	{
...
FK_CONTROL_CONSTRUCTOR( MenuItem )
{
	m_Menu = NULL;
	m_bOnStrip = false;
	m_SubmenuArrow = NULL;
...
void MenuItem::SetAccelerator( const UITexObjSimpleInfo & strAccelerator )
{
	if ( m_Accelerator )
	{
